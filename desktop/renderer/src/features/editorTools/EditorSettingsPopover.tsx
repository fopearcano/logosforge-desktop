...
import { SyntaxThemeSelector } from './syntax/SyntaxThemeSelector';
      ...
      {() => (
        <div className="wb-settings">
          ...
          <label className="wb-field wb-field-check">
            ...
            <span>
              Syntax highlighting <kbd>⌘/Ctrl ⇧ H</kbd>
            </span>
          </label>

          <label className="wb-field">
            <span>Syntax theme</span>
            <SyntaxThemeSelector value={tools.syntaxTheme} onChange={(id) => update('syntaxTheme', id)} />
          </label>
