 ...
 * Verifies the 6 palettes, the readability invariant (Part 7), and custom-theme
...
// 4. resolveTheme
check('resolve predefined', resolveTheme('klein-blue', DEFAULT_CUSTOM_FIELDS).id === 'klein-blue');
...
check('getPredefinedTheme', getPredefinedTheme('red-room')?.name === 'Red Room');
